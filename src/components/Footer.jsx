...
const Footer = () => {
    return(
        <footer className="border-t-[1px] border-stone-400 flex justify-center items-center text-white">
            <div className="w-full max-w-[1000px] flex justify-between items-center p-5">
                <p>&copy; <span>{year}</span> Bartosz Widlak</p>
                <div className='flex items-center w-[150px] justify-between *:hover:opacity-70 *:transition-opacity *:p-2'>
